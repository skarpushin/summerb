...
/**
 * "Embedded" MariaDB server. It is not actually embedded -- it is more like portable because {@link
...
public class EmbeddedMariaDbConfig {
  public static final String DB_NAME = "summerb";
  ...
  protected void invokeInitScripts(DB db, String dbName) throws ManagedProcessException {
    db.source("embedded-db/init_db.sql", DB_NAME);
  }
