...
/**
 * This extension will trim operations returned by Swagger based on roles they
 * are permitted for to match current user Roles. This works based on data
 * populated by {@link OperationBuilderPluginSecuredAware}
 *
 * @author sergeyk
 */
public class ServiceModelToSwagger2MapperImplEx<TUser extends User> extends ServiceModelToSwagger2MapperImpl {
	@Autowired
	...
	/**
	 * This extension will prevent empty controller from appearing in the list (step
	 * 1)
	 */
	@Override
