...
/**
 * This impl was created to pass userName to the login form so that user don't have to enter it
 * after failed previos login attempt
 *
 * @author sergey.k
 */
public class AuthenticationFailureHandlerImpl extends SimpleUrlAuthenticationFailureHandler {
  ...
  @Autowired private UsernamePasswordAuthenticationFilter usernamePasswordAuthenticationFilter;
