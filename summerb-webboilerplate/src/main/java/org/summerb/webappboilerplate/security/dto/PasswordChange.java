...
public class PasswordChange {
  ...
  /**
   * IMPORTANT: This is a little hack, but thi field is intentionally called password, but not
   * newPassword, in order to avoid the need of ValidationException mapping comed from User service
   */
