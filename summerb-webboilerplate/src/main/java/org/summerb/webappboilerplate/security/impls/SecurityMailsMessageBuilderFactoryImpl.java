...
public class SecurityMailsMessageBuilderFactoryImpl
    implements SecurityMailsMessageBuilderFactory, InitializingBean {
  private Logger log = LoggerFactory.getLogger(getClass());

  public static final String EMAIL_REGISTRATION_CONFIRMATION_REQUEST =
      "email-registration-confirmation-request";
  ...
  public EmailMessageBuilder createEmailMessageBuilderFromArticle(String articleKey, User sender) {
    try {
      ...
      throw new RuntimeException(
          "Failed to create email message builder using article id: " + articleKey, t);
    }
  }
  ...
  public EmailMessageBuilder getRegistrationEmailBuilder() {
    if (registrationEmailBuilder == null) {
      registrationEmailBuilder =
          createEmailMessageBuilderFromArticle(
              EMAIL_REGISTRATION_CONFIRMATION_REQUEST, registrationEmailSender);
    }
  ...
  public EmailMessageBuilder getPasswordResetEmailBuilder() {
    if (passwordResetEmailBuilder == null) {
      passwordResetEmailBuilder =
          createEmailMessageBuilderFromArticle(
              EMAIL_PASSWORD_RESET_REQUEST, registrationEmailSender);
    }
