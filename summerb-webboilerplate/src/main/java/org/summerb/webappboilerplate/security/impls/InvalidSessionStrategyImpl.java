...
/**
 * That impl was created to be able to remember url that was initially requested by user so that we
 * can redirect there after successful authentication
 *
 * @author sergeyk
 */
public class InvalidSessionStrategyImpl implements InvalidSessionStrategy, InitializingBean {
  ...
  public void onInvalidSessionDetected(HttpServletRequest request, HttpServletResponse response)
    ...
    String redirecctTo =
        securityActionsUrlsProvider.getInvalidSession()
            + "?requestedUrl="
