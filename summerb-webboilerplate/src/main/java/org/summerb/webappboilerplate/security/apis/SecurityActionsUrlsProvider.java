...
/**
 * This interface provides url paths (excluding base path) for certain {@link LoginController}
 * actions.
 *
 * <p>Impl supposed to be in sync with mappings specified in {@link LoginController}. If mapping
 * need to be changed, then you'll need to create sub-class of {@link LoginController} and override
 * RequestMapping where needed
 *
 * @author sergeyk
 */
