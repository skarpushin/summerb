...
public class ArticlesAuthoringController extends ControllerBase {
  ...
  public @ResponseBody Map<String, ? extends Object> createArticle(
      @RequestBody Article dto, HttpServletResponse response) {
    try {
  ...
  public @ResponseBody Map<String, ? extends Object> deleteArticle(
      Model model, @PathVariable("articleKey") String articleKey, HttpServletResponse response) {
  ...
  public String getArticle(
      Model model, @PathVariable("articleKey") String articleKey, Locale locale)
    ...
    for (Entry<Locale, Article> entry : options.entrySet()) {
      ...
      contentPm.setAttachments(
          new ListPm<Attachment>(
  ...
  public @ResponseBody Map<String, ? extends Object> updateArticle(
      @RequestBody Article dto, @PathVariable("id") long id, HttpServletResponse response) {
    try {
  ...
  public String createAttachment(
      @ModelAttribute(ATTR_ARTICLE_ATTACHMENT) ArticleAttachmentVm articleAttachmentVm,
      Model model,
      @PathVariable("articleId") long articleId)
      throws Exception {
    try {
      Preconditions.checkArgument(
          articleAttachmentVm.getFile() != null
              && articleAttachmentVm.getFile().getFileItem() != null,
          "File required");
  ...
  public @ResponseBody Map<String, ? extends Object> deleteAttachment(
      Model model,
      @PathVariable("articleId") long articleId,
