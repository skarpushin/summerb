...
public class ExceptionUtils {
	...
	/**
	 * Find exception cause of specified type. Will fallback to first exception if
	 * target wasn't found
	 * 
	 * @param t
	...
	/**
	 * We want to ignore these classes when calculating exception code because these
	 * classes behave different fro time to time which negative effect to
	 * consistency of ewxception code
	 */
	private static final Set<String> ignoredStackTraceClasses = new HashSet<String>(
			Arrays.asList("org.apache.tomcat.util.net.JIoEndpoint$SocketProcessor"));
