...
/**
 * This wrapper is used to indicate that this event is originating from other origin (other server
 * node for example). We can use that wrapper to ensure we are not re-sending this event to other
 * nodes
 *
