...
public class EasyCrudExceptionStrategyDefaultImpl<TId> implements EasyCrudExceptionStrategy<TId> {
	...
	@Override
	public RuntimeException handleExceptionAtCreate(Throwable t) throws FieldValidationException,
	...
	@Override
	public RuntimeException handleExceptionAtDelete(Throwable t) throws NotAuthorizedException, EntityNotFoundException {
		Throwables.propagateIfInstanceOf(t, NotAuthorizedException.class);
	...
	@Override
	public RuntimeException handleExceptionAtUpdate(Throwable t) throws FieldValidationException,
			NotAuthorizedException, EntityNotFoundException {
		Throwables.propagateIfInstanceOf(t, FieldValidationException.class);
		Throwables.propagateIfInstanceOf(t, NotAuthorizedException.class);
		Throwables.propagateIfInstanceOf(t, EntityNotFoundException.class);
