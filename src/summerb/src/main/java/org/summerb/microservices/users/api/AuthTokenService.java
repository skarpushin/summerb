...
public interface AuthTokenService {
	...
	/**
	 * This is high-level auth method. It will verify credentials and return
	...
	/**
	 * Verify token validity and if valid updated it with new values for
	 * tokenValue and lastUpdated.
	 * 
	 * This is a convenient all-in-one method. You don't have to use it if you
	 * want to implement custom token validation checks, don't forget to use
	 * {@link #updateToken(String, long, String)} to mitigate the
	 * "stolen token database" situation
	 * 
	 * @param userUuid
	 ...
	 * @param newTokenValue
	 *            new value for tokenValue field. It MUST NOT be equal to
	 *            previous value
