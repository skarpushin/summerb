...
import org.summerb.dbupgrade.impl.postgres.SqlPackageParserPostgresImpl;
import org.summerb.dbupgrade.impl.postgres.VersionTableDbDialectPostgresImpl;

@Configuration
public class TestPostgresConfig extends TestConfigBase {
  @Override
  ...
  protected SqlPackageParser sqlPackageParser() {
    return new SqlPackageParserPostgresImpl();
  }

  @Bean
  @Override
  protected VersionTableDbDialect versionTableDbDialect() {
    return new VersionTableDbDialectPostgresImpl();
  }
}
