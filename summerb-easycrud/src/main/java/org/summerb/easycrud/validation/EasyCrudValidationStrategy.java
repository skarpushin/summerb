 ...
 * the License.
 ******************************************************************************/
package org.summerb.easycrud.validation;
 ...
 * separately
 *
 * <p>In case validation rules are the same for both {@link EasyCrudService#create(HasId)} and
 * {@link EasyCrudService#update(HasId)}, consider subclassing {@link
