...
/**
 * That dto describes reference from one object to another. It's designed to describe only
...
public class Ref implements Serializable {
   ...
   * @deprecated avoid using it since reverse is not 100% implemented, doesn't cover all cases of
   *     {@link #relationType}
   */
  @Deprecated
  public Ref reverse() {
  ...
  /**
   * @return relation type that supposed to help application to handle cascade changes automaticall.
   *     Reserved for future used, not actually handled/implemented
