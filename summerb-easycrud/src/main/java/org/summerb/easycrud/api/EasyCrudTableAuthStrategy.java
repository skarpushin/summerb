...
/**
 * Strategy for authorizing table-wide operation. Used in case when all rows have same authorization
 * rules.
 *
 * <p>Normally injected into {@link EasyCrudService} via {@link EasyCrudWireTap} (particularly
 * {@link EasyCrudWireTapPerRowAuthImpl} ), but also can be used separately.
 *
 * <p>In case you need per-row authorization rules use {@link EasyCrudPerRowAuthStrategy}.
 *
