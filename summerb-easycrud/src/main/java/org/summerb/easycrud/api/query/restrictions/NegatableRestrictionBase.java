...
public abstract class NegatableRestrictionBase<T>
    implements CanHaveNegativeMeaning, Serializable, Restriction<T> {
  ...
  public boolean equals(Object obj) {
    ...
    NegatableRestrictionBase<?> other = (NegatableRestrictionBase<?>) obj;
