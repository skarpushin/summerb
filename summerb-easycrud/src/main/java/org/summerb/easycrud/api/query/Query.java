...
public class Query<TId, TRow extends HasId<TId>> {
  ...
  public Query<TId, TRow> or(List<? extends Query<TId, TRow>> disjunctions) {
  ...
  public Query<TId, TRow> in(String fieldName, Object... values) {
    return in(fieldName, Arrays.asList(values));
  }

  public Query<TId, TRow> notIn(String fieldName, Object... values) {
