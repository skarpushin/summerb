...
public class DataTable<TId, T extends HasId<TId>> {
   ...
   *     table
   * @deprecated avoid using this -- in future versions it might be removed. Initially I thought
  ...
  /**
   * MAPS {@link Ref} TO set of ids of matching objects from other table. Presumably fromTable field
   * in {@link Ref} object will always point to this table.
   *
   * @author sergeyk
   */
  ...
  /**
   * This data structure is used to contain all back refs from specific row in this table to all
   * references loaded by {@link DataSetLoader}
   *
   * @author sergeyk
   */
