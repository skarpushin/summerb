...
public class In extends NegateableRestriction<In> implements HasEmptyResultSetPrediction {
  ...
  @Override
  public boolean isPredictsEmptyResult() {
    return (!this.isNot() && CollectionUtils.isEmpty(values));
  }
