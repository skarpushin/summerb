...
/**
 * WireTap which will invoke injected {@link EasyCrudTableAuthStrategy} when accessing or modifying
 * data.
 *
 * <p>It doesn't require full dto thus it doesn't prevent {@link EasyCrudService} from performing
 * batch operations.
 *
 * @author sergeyk
 */
public class EasyCrudWireTapTableAuthImpl<TId, TDto extends HasId<TId>>
