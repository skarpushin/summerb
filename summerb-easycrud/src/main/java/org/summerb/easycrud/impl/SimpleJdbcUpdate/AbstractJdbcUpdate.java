...
public abstract class AbstractJdbcUpdate {
	...
	protected int doExecute(Map<String, Object> updatingValues, Map<String, Object> restrictingValues) {
		...
		values.addAll(matchInParameterValuesWithUpdateColumns(restrictingValues,
				new ArrayList<String>(restrictingColumns.keySet())));
	...
	private void reconcileUpdatingColumns() {
		...
		reconciledUpdatingColumns.addAll(getUpdateColumnsEnlisterStrategy().getColumnsForUpdate(tableMetaDataContext));
	}
	...
	public void setUpdateColumnsEnlisterStrategy(UpdateColumnsEnlisterStrategy updateColumnsEnlisterStrategy) {
