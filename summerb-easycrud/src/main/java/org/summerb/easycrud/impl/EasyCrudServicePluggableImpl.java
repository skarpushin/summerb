 ...
 *
 * <p>If your DTO implements {@link HasAuthor} interface then this impl requires compatible {@link
 * CurrentUserResolver} to be injected.
 *
 * @author sergeyk
 ...
 */
public class EasyCrudServicePluggableImpl<
        TId, TDto extends HasId<TId>, TDao extends EasyCrudDao<TId, TDto>>
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    Preconditions.checkState(
        !HasAuthor.class.isAssignableFrom(rowClass) || currentUserResolver != null,
  ...
  @Override
  public TDto create(TDto row) throws ValidationException, NotAuthorizedException {
    try {
  ...
  public void setGenericExceptionStrategy(
      EasyCrudExceptionStrategy<TId> easyCrudExceptionStrategy) {
