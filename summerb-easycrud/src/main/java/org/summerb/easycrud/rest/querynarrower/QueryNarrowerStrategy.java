...
/**
 * Provide a sub-class that will alter queries before query will be issued to service. I.e. useful
 * to narrow queries only to items available to current user OR which contained in current context
