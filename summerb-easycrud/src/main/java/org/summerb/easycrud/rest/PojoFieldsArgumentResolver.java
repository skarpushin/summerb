 ...
 * with matching names will be mapped
 *
 * <p>This impl is brutally simple and a little "hack-ish". It basically relies on {@link Gson} as
 * deserializer/mapper from request parameters.
 *
 * <p>If at some point this approach will be deemed wrong then we'll need to impl something more
 * sophisticated, similar to {@link BeanPropertyRowMapper}
 *
 * <p>TBD: Add usage example
 *
 * @author sergeyk
 */
