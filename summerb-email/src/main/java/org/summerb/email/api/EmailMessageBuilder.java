 ...
 *
 * <p>For example you need to periodicaly send some email. This builder will have precompiled
 * version of email tempalte and specific email instance might be acquired by calling {@link
 * #buildEmail(String, String, EmailTemplateParams)}
 *
 * @author skarpushin
 */
