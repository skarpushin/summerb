...
/**
 * Contains email message params (!), not body or template of the body, but their params.
 *
 * <p>{@link #getFrom()}, {@link #getTo()}, {@link #getBody()} used when evaluating pre-compiled
 * email template {@link EmailMessageBuilder} and so contains template arguments/parameters, not
 * content itself.
 *
 * <p>Instance of this class is exposed as root object to templates evaluation context
 *
 * @author skarpushin
 */
