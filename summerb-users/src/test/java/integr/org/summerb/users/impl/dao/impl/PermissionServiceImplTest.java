...
public class PermissionServiceImplTest {
	...
	public void testGranPermission_expectPermissionWillBeFoundAfterCreation() throws Exception {
		...
		List<String> results = permissionService.findUserPermissionsForSubject("domain", "user", "subject");
	...
	public void testRevokeUserPermissions_expectNoPermissionsAfterRevokation() throws Exception {
		...
		List<String> results = permissionService.findSubjectsUserHasPermissionsFor("domain", "user1", "permission");
		assertEquals(0, results.size());
	}

	@Test
	public void testRevokeAllPermissionsForSubject_expectNoPermissionsAfterClearence() throws Exception {
		// preconditions
		permissionService.grantPermission("domain", "user1", "subject1", "permission");
		permissionService.grantPermission("domain", "user1", "subject2", "permission");
	...
	@Test
	public void testGetSubjectsUserHasPermissionsFor_expectNoPermissionsAfterClearence() throws Exception {
		// preconditions
		...
		// fixture
		List<String> results = permissionService.findSubjectsUserHasPermissionsFor(null, "user1", "permission2");
	...
	@Test
	public void testGetUsersAndTheirPermissionsForSubject_expectAllAppropriateDataWillBeReturned() throws Exception {
		permissionService.grantPermission(null, "user1", "subject1", "permission1");
		...
		Map<String, List<String>> results = permissionService.findUsersAndTheirPermissionsForSubject(null, "subject1");
