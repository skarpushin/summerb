...
/**
 * This simple impl is used to enforce attachments deletion before article will be deleted.
 * Unfortunately there is not transaction management. If later logic fails it might happen that
 * attachment files are deleted, but rows in both articles and attachments tables remain. (that will
 * happen if use @see AttachmentDaoExtFilesImpl)
 *
 * @author sergeyk
...
public class ArticleDaoAttachmentRemoverWrapper implements ArticleDao {
  ...
  @Override
  public PaginatedList<Article> query(
