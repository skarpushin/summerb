...
public class ArticleRenderingContext {
  ...
  public ArticleRenderingContext(
      Locale locale,
  ...
  /** @return map partial impl for handy access to other article from article template by key */
  public Map<String, String> getArticle() {
    if (article == null) {
      article =
          new DummyMapImpl<String, String>() {
            @Override
            public String get(Object articleKey) {
              try {
                ...
                stringBuffer.append(
                    articleAbsoluteUrlBuilder.buildUrlFroArticle(referencedArticle));
                ...
                log.error(
                    "Render failure for "
                        + renderedArticle.getArticleKey()
                        + ", can't find dependency "
                        + nfe.getSubjectTypeMessageCode()
                        + ":"
                        + nfe.getIdentity());
              } catch (Throwable t) {
                log.error(
  ...
  private void checkReferencedArticleKeyPreconditions(Object articleKey) {
    ...
    Preconditions.checkArgument(
        articleKey.toString().length() > 0, "Article key must be specified");
    Preconditions.checkArgument(
        !renderedArticle.getArticleKey().equals(articleKey), "Article can't reference itself");
  }
  ...
  protected Article getReferencedArticle(String articleKey) throws GenericEntityNotFoundException {
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to find effective referenced article permutation " + articleKey, e);
    }
  }
      ...
      img =
          new DummyMapImpl<String, String>() {
            ...
            public String get(Object name) {
              ...
              Preconditions.checkArgument(
                  name.toString().length() > 0, "Filename must be specified");
      ...
      attachment =
          new DummyMapImpl<String, String>() {
            ...
            public String get(Object attachmentFileName) {
              ...
              Preconditions.checkArgument(
                  attachmentFileName.toString().length() > 0, "Filename must be specified");
      ...
      pageUrl =
          new DummyMapImpl<String, String>() {
            ...
            public String get(Object relativeUrl) {
              ...
              Preconditions.checkArgument(
                  relativeUrl.toString().length() > 0, "Url must be specified");
